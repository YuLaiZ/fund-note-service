...
(
    3
) null comment '基金类型(1-普通开放式公募基金,2-货币基金,3-QDII基金)',
...
(
    ...
    update_time datetime null comment '更新时间',
    index fn_note_fund_record_note
(
    note_id
),
    index fn_note_fund_record_fund
(
    fund_id
)
    )
...
(
    3
) null comment '持有状态(0-未生效,1-持有,2-清仓)',
    update_time datetime null comment '更新时间',
    index fn_note_fund_rel_note
(
    note_id
)
    )
